package com.mybatis.generator.plus;
...
public class MyCommentGenerator extends DefaultCommentGenerator {
    ...
    public void addEnumComment(InnerEnum innerEnum, IntrospectedTable introspectedTable) {
        addCommonComment(innerEnum, introspectedTable);
    }
    ...
    public void addFieldComment(Field field, IntrospectedTable introspectedTable) {
        addCommonComment(field, introspectedTable);
    }
     ...
     */
    private void addCommonComment(JavaElement field, IntrospectedTable introspectedTable) {
        if (suppressAllComments) {
            return;
        }
        StringBuilder sb = new StringBuilder();
    ...
    public void addJavaFileComment(CompilationUnit compilationUnit) {
        ...
        compilationUnit.addFileCommentLine("* Copyright(C) 2018-2020 xx公司");
